...
public class DroneScrolling3{
	...
	public DroneScrolling3() {
		forward 	= getImage("/imgs/"+"droneleft-pixilart (2).png"); //load the image for Tree
	...
	public DroneScrolling3(int x, int y) {
...
public boolean collided(Spiderman character) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = DroneScrolling3.class.getResource(path);
